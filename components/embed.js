...
class EZEmbed {
    ...
    render() {
        ...
        if (!document.getElementById('discord-embed-styles')) {
            this._addStyles();
        }

        // Add the color click event listener if callback provided
        ...
        return `
            <div class="author-section">
                ${this.options.author.iconUrl ?
                    `<div class="author-icon"><img src="${this.options.author.iconUrl}" alt=""></div>` :
                    ''}
    ...
    _renderFooter() {
        ...
        return `
            <div class="embed-footer">
                ...
                ${this.options.footer.timestamp ?
                    `<div class="footer-timestamp">${new Date().toLocaleString()}</div>` :
                    ''}
            </div>
        `;
    }
    ...
    // Public methods to update the embed
    update(newOptions) {
    ...
    // Get the embed as a JSON object (compatible with Discord's API)
    toJSON() {
        const embed = {
            ...
            timestamp: this.options.footer && this.options.footer.timestamp ?
